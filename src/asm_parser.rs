...
pub fn parse_opcode(s: &str) -> Option<Opcode> {
    ...
    Some(match pieces[0] {
        ...
        "cpuid" => Opcode::CPUID,
        "cqto" => Opcode::CQTO,
        "cvtps2pd" => Opcode::CVTPS2PD,
        "cvtpd2ps" => Opcode::CVTPD2PS,
        "cvtsi2sd" => Opcode::CVTSI2SD,
        "cvtsi2ssq" => Opcode::CVTSI2SSQ,
        ...
        "pinsrb" => Opcode::PINSRB,
        "pinsrd" => Opcode::PINSRD,
        "pinsrw" => Opcode::PINSRW,
        "pmovmskb" => Opcode::PMOVMSKB,
        "movmskps" => Opcode::MOVMSKPS,
        "movmskpd" => Opcode::MOVMSKPD,
        ...
        "vbroadcastss" => Opcode::VBROADCASTSS,
        ...
        "pclmulhqhqdq" => Opcode::PCLMULHQHQDQ,
        "vpclmulhqlqdq" => Opcode::VPCLMULHQLQDQ,
        "pclmulhqlqdq" => Opcode::PCLMULHQLQDQ,
        ...
        "andps" => Opcode::ANDPS,
        "andpd" => Opcode::ANDPD,
        "cmpnltsd" => Opcode::CMPNLTSD,
        "cmpnlesd" => Opcode::CMPNLESD,
        "cmpnless" => Opcode::CMPNLESS,
        "divq" => Opcode::DIVQ,
        "faddp" => Opcode::FADDP,
        "fadds" => Opcode::FADDS,
        "fdivp" => Opcode::FDIVP,
        ...
        "decq" => Opcode::DECQ,
        "divl" => Opcode::DIVL,
        "fnstenv" => Opcode::FNSTENV,
        "fnstcw" => Opcode::FNSTCW,
        "fnstsw" => Opcode::FNSTSW,
        "fxam" => Opcode::FXAM,
        "fxsave" => Opcode::FXSAVE,
        "idivq" => Opcode::IDIVQ,
        "incq" => Opcode::INCQ,
        "jnp" => Opcode::JNP,
        ...
        "pinsrq" => Opcode::PINSRQ,
        "pclmullqlqdq" => Opcode::PCLMULLQLQDQ,
        "adox" => Opcode::ADOX,
        "mulx" => Opcode::MULX,
        "minsd" => Opcode::MINSD,
        "minss" => Opcode::MINSS,
        "fabs" => Opcode::FABS,
        "vfnmadd231sd" => Opcode::VFNMADD231SD,
        "roundsd" => Opcode::ROUNDSD,

        "bnd" => return parse_opcode(pieces[1]),
